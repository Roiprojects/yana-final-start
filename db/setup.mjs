...
// 4. Offices — check-then-insert/update (safe to re-run; does not wipe existing entries)
const offices = [
...
for (const o of offices) {
  ...
  if (rows.length > 0) {
    ...
    await client.query(
      `insert into contact_info (office_name, address, city, pincode, sort_order, is_active) values ($1,$2,$3,$4,$5,true)`,
