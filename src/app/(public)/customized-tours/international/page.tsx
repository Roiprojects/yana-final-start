...
export const metadata: Metadata = {
  title: "International Customized Tours",
  description: "Bespoke international trips designed to your preferences.",
};

export default function InternationalCustomizedToursPage() {
  return (
    <>
      <PageHeader
