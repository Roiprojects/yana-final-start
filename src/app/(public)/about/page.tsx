...
import { MapPin, Compass, HeartHandshake, ShieldCheck, Sparkles } from "lucide-react";
...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn about Yana Travels — a travel company planning group and customized tours across India and abroad.",
};
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
          <Reveal>
            <div className="max-w-3xl">
              <p className="eyebrow text-[#ad7f19]">Welcome to Yana · Est. {siteConfig.founded}</p>
              <h2 className="mt-2 text-3xl font-extrabold tracking-[-0.04em] md:text-4xl">
                Travel expertise presented with more confidence, warmth, and polish
              </h2>
              <div className="mt-5 space-y-4 text-lg leading-8 text-text-secondary">
                <p>
                  Yana Travels was founded in {siteConfig.founded}. We are a team of travel experts with deep knowledge of historic, scenic, and culturally rich destinations across India and abroad.
                </p>
                <p>
          ...
          <Reveal delay={120}>
            <div className="rounded-[1.9rem] border border-[#eadfcf] bg-[linear-gradient(135deg,#fffefb,#f7f1e4)] p-7 shadow-[0_24px_56px_-34px_rgba(16,33,58,0.28)]">
              ...
              <h3 className="text-xl font-extrabold tracking-[-0.03em] text-deep">Why the brand feels stronger now</h3>
      ...
      <Section tone="soft">
        <Reveal>
          <div className="mb-8 max-w-2xl">
            ...
            <h2 className="mt-2 text-2xl font-extrabold tracking-[-0.03em] md:text-3xl">Travel services arranged around real needs</h2>
          </div>
        </Reveal>
          ...
          {offerings.map((item, i) => (
            <Reveal key={item} delay={i * 60}>
              <div className="h-full rounded-[1.45rem] border border-[#eadfcf] bg-white p-5 shadow-[0_18px_40px_-28px_rgba(16,33,58,0.24)]">
                ...
                <span className="text-sm font-semibold leading-6 text-text-main">{item}</span>
              </div>
            </Reveal>
          ))}
        </div>
          ...
          {values.map((v, i) => (
            <Reveal key={v.title} delay={i * 110}>
              <div className="h-full rounded-[1.7rem] border border-[#eadfcf] bg-white p-7 shadow-[0_22px_48px_-30px_rgba(16,33,58,0.26)]">
                ...
                <h3 className="text-lg font-bold tracking-[-0.02em]">{v.title}</h3>
      ...
      <Section tone="soft">
        <Reveal>
          <div className="mb-8 max-w-2xl">
            ...
            <h2 className="mt-2 text-2xl font-extrabold tracking-[-0.03em] md:text-3xl">Offices that keep the journey connected</h2>
          </div>
        </Reveal>
            ...
            <Reveal key={office.name} delay={i * 100}>
              <div className="flex h-full items-start gap-4 rounded-[1.7rem] border border-[#eadfcf] bg-white p-6 shadow-[0_18px_44px_-30px_rgba(16,33,58,0.24)]">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-text-secondary">{office.address}</p>
                </div>
              </div>
            </Reveal>
          ))}
