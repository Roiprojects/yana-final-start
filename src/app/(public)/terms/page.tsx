...
export const metadata: Metadata = {
  ...
  description:
    "Yana Travels booking terms and conditions — payment, cancellation, accommodation, transport, and tour operation.",
};
      ...
      <Section>
        <div className="mx-auto max-w-3xl space-y-8">
          <p className="rounded-xl border border-border-soft bg-bg-soft p-4 text-sm text-text-secondary">
            These terms are taken from the Yana Travels brochure. Specific prices,
            dates and charges are confirmed at the time of booking.
          </p>
          {sections.map((sec, i) => (
