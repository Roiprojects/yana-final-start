...
import { ActiveToggle, FeaturedToggle } from "@/components/admin/package-toggles";
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-text-secondary">
            {packages.length} packages · edit content, toggle visibility and featured status.
          </p>
        </div>
        <Link
                ...
                {packages.map((p) => (
                  <tr key={p.id} className="hover:bg-bg-soft/50">
                    <td className="px-4 py-3">
                      ...
                      <div className="text-xs text-text-secondary">{p.slug}</div>
                    </td>
                    ...
                    <td className="px-4 py-3 text-center">
                      <FeaturedToggle id={p.id} featured={p.is_featured} />
                    </td>
                    <td className="whitespace-nowrap px-4 py-3">
