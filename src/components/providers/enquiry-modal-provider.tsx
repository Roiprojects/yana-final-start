        ...
        {submitted ? (
          ...
          <div>
            ...
            >
              ...
              {/* Phone with India flag & code */}
              <div>
                <div className="relative flex items-center rounded-xl border border-gray-200 bg-white transition-colors focus-within:border-[#0b66e4] focus-within:ring-2 focus-within:ring-[#0b66e4]/20">
                  <div className="flex shrink-0 items-center gap-1.5 border-r border-gray-200 py-3.5 pl-3 pr-2.5 text-xs font-semibold text-gray-700 select-none">
