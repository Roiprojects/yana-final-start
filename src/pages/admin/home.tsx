...
const sections = [
  {
    title: "Hero Banners & Quotes",
    description:
      "Manage top banner slideshow, quote text & call to action buttons.",
    href: "/admin/hero",
    icon: Sparkles,
  },
  {
    title: "Featured Destinations",
    description: "Manage travel destinations highlighted on homepage.",
    href: "/admin/destinations",
    icon: MapPin,
  },
  {
    title: "Travel Services",
    description: "Manage flight bookings, forex, visa, and tour services.",
    href: "/admin/services",
    icon: Briefcase,
  },
  {
    title: "Customer Reviews",
    description: "Manage customer testimonials and star ratings.",
  ...
  },
  {
    ...
    description: "Manage office addresses and contact numbers.",
    href: "/admin/contact",
    icon: HelpCircle,
  },
];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Select a section below to edit content live on the home page.
        </p>
      </div>
