 ...
 * Server-only. Reads DATABASE_URL from the environment (.env.local, git-ignored).
 * The pool is cached on globalThis so Next.js hot-reload doesn't leak connections.
 */
