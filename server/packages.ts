...
import generatedRaw from "../src/lib/data/packages.generated.json";

/**
 * Data access for tour packages (server-side).
 ...
 * client's official trip-package PDFs so the site still renders real content.
